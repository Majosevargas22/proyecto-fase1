...
def menu():
    ...
    scoresBtn = button(RED, 300, 300, 200, 25, "PUNTUACIONES")
...
def scores():
    ...
    scoresClear = button(RED, 450, 450, 200, 25, "Limpiar Puntuaciones")
...
def instructions():
    ...
    backBtn = button(RED, 550, 450, 200, 25, "Atras")
...
def enterName():
    ...
    labelEnterName = myfont.render("Escriba su nombre :", 1, BLACK)
